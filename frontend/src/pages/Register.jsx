        ...
        <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center bg-[#FAF9F4] px-4 pb-20">
            ...
            >
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-extrabold text-[#222222] tracking-tight">Create account.</h2>
                    <p className="mt-2 text-[#5C5C5C] font-medium text-[15px]">Start planning your dream vacations with AI.</p>
                </div>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <a
                        ...
                        className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-xl border border-[#E5E6E1] bg-white hover:bg-gray-50 transition-all font-semibold text-[15px] text-[#222] shadow-sm"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex justify-center items-center py-3.5 px-4 rounded-xl text-white font-bold bg-[#6D8365] hover:bg-[#586A51] transition-colors disabled:opacity-50 mt-6 shadow-sm"
                    >
                    ...
                    <div className="text-center text-[15px] pt-4 border-t border-gray-100 mt-6">
                        ...
                        <Link to="/login" className="font-bold text-[#6D8365] hover:text-[#586A51] underline transition-colors">
                            Sign in
                        </Link>
                    </div>
                </form>
